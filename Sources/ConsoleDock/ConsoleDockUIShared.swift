    ...
    enum ConsoleDockAccessibilityIdentifiers {
        ...
        static let createSupportReport = "consoledock.create-support-report"
        static let supportReportComposer = "consoledock.support-report.composer"
        static let supportReportRangeControl = "consoledock.support-report.range"
        static let supportReportCustomRangeButton = "consoledock.support-report.custom-range"
        static let supportReportRangeDescription = "consoledock.support-report.range-description"
        static let supportReportAppContextSwitch = "consoledock.support-report.app-context"
        static let supportReportIntegrationHealthSwitch = "consoledock.support-report.health"
        static let supportReportSummary = "consoledock.support-report.summary"
        static let supportReportPreview = "consoledock.support-report.preview"
        static let copySupportReportButton = "consoledock.support-report.copy"
        static let shareSupportReportButton = "consoledock.support-report.share"
        static let supportReportStartDate = "consoledock.support-report.start-date"
        static let supportReportEndDate = "consoledock.support-report.end-date"
        static let supportReportApplyDateRange = "consoledock.support-report.apply-date-range"
