...
ConsoleDock is a debug and test SDK for iOS apps. It stores redacted log entries in local memory with stable session identifiers and processing flags, displays them in a bundled UIKit console, and keeps Release builds disabled by default.
