...
- The UIKit floating button and console panel foundation can show, live refresh, clear, share/export, and close the current in-memory snapshot.
- Search, pause/resume, selected-entry copy, persistence, and advanced filtering are not implemented yet.
