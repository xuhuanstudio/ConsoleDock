...
REQUIRED_IDENTIFIERS = {
    pathlib.Path("Sources/ConsoleDock/ConsoleDockUIShared.swift"): [
        ...
        "consoledock.create-support-report",
        "consoledock.support-report.composer",
        "consoledock.support-report.range",
        "consoledock.support-report.custom-range",
        "consoledock.support-report.range-description",
        "consoledock.support-report.app-context",
        "consoledock.support-report.health",
        "consoledock.support-report.summary",
        "consoledock.support-report.preview",
        "consoledock.support-report.copy",
        "consoledock.support-report.share",
        "consoledock.support-report.start-date",
        "consoledock.support-report.end-date",
        "consoledock.support-report.apply-date-range",
