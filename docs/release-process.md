...
1. Decide the version, for example `v0.4.0`.
2. Move completed `CHANGELOG.md` entries from `Unreleased` into a heading that matches the tag, for example `## v0.4.0 - 2026-06-26`.
...
5. Verify search, source filter, level filter, pause/resume, log detail copy, marker creation, visible/all/issue-report share, Debug Actions, clear, stop, and restart behavior.
