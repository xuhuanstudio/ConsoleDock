...
1. Decide the version, for example `v0.6.0`.
2. Move completed `CHANGELOG.md` entries from `Unreleased` into a heading that matches the tag, for example `## v0.6.0 - 2026-06-26`.
