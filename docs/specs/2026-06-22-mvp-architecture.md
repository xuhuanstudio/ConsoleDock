...
| UI | floating button and console panel | UI appears in Debug, opens, searches, source-filters, live-updates, clears, closes, displays redacted entries, and can share/export the current visible redacted snapshot. Pause/resume, selected-entry copy, and advanced filtering are later developer-experience work. |
