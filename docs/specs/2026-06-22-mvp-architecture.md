...
| UI | floating button and console panel | UI appears in Debug, opens, searches, source-filters, pauses/resumes live follow, live-updates, clears, closes, displays redacted entries, and can share/export the current visible redacted snapshot. Selected-entry copy and advanced filtering are later developer-experience work. |
