...
该脚本会先确认工作区干净，再验证 SwiftPM manifest、Swift 格式、构建、测试、Release safety gates、文档链接、公开发布内容审计、DocC、iOS package build、Swift/Objective-C 示例 App 构建、source archive 生成和 source archive 内容。
