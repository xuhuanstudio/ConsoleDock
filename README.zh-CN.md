...
ConsoleDock `v0.9.0` 是当前 source-first Swift Package Manager 公开预览版本，包含：
...
- 日志详情页、单条复制、Logs 本地结构化查询、Logs Jump、reproduction timeline，以及 visible/all/issue report 分享；
